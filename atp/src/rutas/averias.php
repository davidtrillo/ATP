...
$app->get('/api/averias/pendientes',function(Request $request, Response $response){
    ...
    $sql="SELECT a.id, t.estado, a.fecha,t.fecha as fechafin , a.instalacion,a.averia,a.ubicacion FROM atp.averia a inner join atp.estado t on a.id=t.idaveria WHERE t.id IN (SELECT MAX(id) FROM atp.estado GROUP BY idaveria) ORDER BY t.id DESC";
