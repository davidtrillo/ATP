            ...
            <div class="row p-0">
                    <div class="col-xl-1 col-lg-2 col-md-3 p-1 ml-0">
                        <div class="input-group">
                            ...
                            <button class="btn btn-outline-warning" type="button" id="button-addon1"><i class="fas fa-info-circle"></i></button>
                            </div>
...
async function getRealizadas(){
    ...
    t.innerHTML=``;
            ...
            var url = 'http://172.27.120.120/atp/public/api/averias/acabadas';
